...
hittable_list random_scene() {
    ...
    world.add(std::make_shared<sphere>(vec3(-4,1,0), 1.0, std::make_shared<lambertian>(vec3(0.4, 0.2, 0.1))));
...
int main() {
    ...
    constexpr auto aspect_radio = double(image_width) / image_height;
