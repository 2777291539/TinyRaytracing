...
int main() {
    ...
    world.add(std::make_shared<sphere>(vec3(1,0,-1), 0.5, std::make_shared<metal>(vec3(0.8, 0.6, 0.2))));
    world.add(std::make_shared<sphere>(vec3(-1,0,-1), 0.5, std::make_shared<metal>(vec3(0.8, 0.8, 0.8))));
    camera cam;
